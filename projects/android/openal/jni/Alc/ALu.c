...
static void CalcNonAttnSourceParams(ALvoice *voice, struct ALsourceProps *props, const ALbuffer *ALBuffer, const ALCcontext *ALContext)
{
...
static void CalcAttnSourceParams(ALvoice *voice, struct ALsourceProps *props, const ALbuffer *ALBuffer, const ALCcontext *ALContext)
{
    const ALCdevice *Device = ALContext->Device;
    const ALlistener *Listener = ALContext->Listener;
