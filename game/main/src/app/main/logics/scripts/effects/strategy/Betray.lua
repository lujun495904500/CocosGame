...
local Betray = class("Betray", import("._StrategyBase"))
...
-- 战场上
function Betray:executeInBattle(onComplete)
						...
						if ishit then
							target:getEntity():addBuff(bid, {}, function ()
								...
								msgwin:appendMessage({
									texts = gameMgr:getStrings("SKILL_BETRAY",{
...
-- 地图上
function Betray:executeInMap(onComplete)
