...
setup(
	...
	ext_modules=[Extension(MODNAME,
		sources=[
			...
			'src/HDiff/private_diff/libdivsufsort/divsufsort.c',
			'src/HDiff/private_diff/libdivsufsort/divsufsort64.c',
			'src/HDiff/private_diff/limit_mem_diff/stream_serialize.cpp',
			'src/HDiff/private_diff/limit_mem_diff/digest_matcher.cpp',
			'src/HDiff/private_diff/limit_mem_diff/adler_roll.c'
		])]) 
